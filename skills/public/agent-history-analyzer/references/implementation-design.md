...
- Refresh online documentation for Codex, Claude Code, uv, text analysis methods,
  privacy/redaction methods, and agent trajectory evaluation methods.
- Inspect local Codex and Claude transcript shapes.
- Create and validate `references/model-field-map.md`.
